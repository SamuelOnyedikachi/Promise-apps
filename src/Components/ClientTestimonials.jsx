...
const ClientTestimonials = () => {
  ...
  return (
    <Wrapper customStyle="bg-[#181818] border-b border-gray-600">
      ...
      <p className="text-amber-50 text-lg sm:text-xl leading-relaxed text-center font-light w-[80%] m-auto ">
      ...
      <GridCards lgCol="3">
        {clients.map((client, index) => (
          <Card key={index}>
            <h2 className="text-center text-primary text-lg font-semibold leading-tight mb-2">
              {client.name}
            </h2>
            <h3 className="text-center font-[600] text-gray-300">
              {client.title}
            </h3>
